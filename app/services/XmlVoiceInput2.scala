...
object XmlVoiceInput2 {
  ...
  def subject2similarity(input2pinyin: String) = {
    ...
    val response2Error = ( "未找到相应的主题模板", 0,  "暂未设置您提到的问题", "请直接根据以下链接进行自助分析", "http://playr.data-talks.com/assets/pic4weixin/DoitYourself.jpg" , "http://playr.data-talks.com/reportR/REPORT_5KPKVlQoZx" )
